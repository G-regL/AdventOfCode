...
for opt, arg in opts:
    if opt in ("-t", "--test"):
        print("\33[31mUSING TEST DATA\33[0m")
        ARG_data = "test.txt"
    elif opt in ("-d", "--debug"):
...
answer_p2: int = sum([e - s + 1 for s, e in known_ranges])
